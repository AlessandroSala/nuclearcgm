...
public:
    ...
    double getElement(int i, int j, int k, int s, int i1, int j1, int k1, int s1, const Grid& grid) const override;
...
public:
    ...
    /** @brief Helper to calculate potential value at a radius r. */
    double calculate_potential(double r) const;
};
