...
\begin{align*}
    \psi''(x)  = f(x, \psi, \psi', E) \ \ \forall x \in [a, b]
\end{align*}
...
\end{equation}
Finding the eigenvalues and eigenvectors of $A$ amounts to finding the solutions $\psi$ and the corrisponding eigenvalues $E$.
