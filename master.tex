...
\begin{figure}
    ...
    \caption{\label{fig:ws_gs} Ground state wavefunction of the Woods-Saxon potential. The solution starts roughly vanishes for $|x|>3$ fm, as expected for a nucleus of this size.}
\end{figure}
